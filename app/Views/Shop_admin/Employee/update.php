    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body p-3">
                <form action="<?= base_url('shop_admin/employee_update_action'); ?>" method="post">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?= $employee->name ?>" required/>
                            </div>
                            <div class="form-group">
                                <label for="varchar">Salary</label>
                                <input type="text" class="form-control" name="salary" id="salary" placeholder="Salary " value="<?= $employee->salary ?>" required />
                            </div>
                            <div class="form-group">
