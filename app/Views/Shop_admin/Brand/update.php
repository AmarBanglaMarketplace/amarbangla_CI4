        ...
        <div class="card">
            ...
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="<?= base_url('shop_admin/brand_update_action'); ?>" method="post" enctype="multipart/form-data" >
                            <div class="form-group">
                                <label for="varchar">Brand Name</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="name" value="<?= $brand->name;?>" required >
                            </div>
                            <div class="form-group">
                                <?= image_view('uploads/brand_image', '', $brand->image, 'no_image.jpg', 'w-25', '') ?><br>
                            ...
                            <input type="hidden" class="form-control" name="brand_id" value="<?= $brand->brand_id;?>" required >
