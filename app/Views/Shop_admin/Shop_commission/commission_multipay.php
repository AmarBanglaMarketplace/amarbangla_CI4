    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-capitalize">Multi pay Commission List</h3>
            </div>
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        <form action="<?= base_url('shop_admin/shop_commission_multipay_action')?>" method="post">
                            <table class="table table-bordered table-striped" id="example1">
                            <thead>
                            <tr>
                                <th>No</th>
                                <th>
                                    <input type="checkbox" id="selectall" name="selectall"  onclick="eventCheckBox()">
                            ...
                            <?php $i = 1; foreach ($supCommision as $val) { ?>
                                <tr>
                                    <td><?= $i++?></td>
                                    <td><input type="checkbox" value="<?= $val->invoice_id; ?>" name="invoiceId[]" ></td>
                            ...
                            <button type="submit" class="btn btn-primary float-right mt-2">Pay </button>
                        </form>
                    </div>
