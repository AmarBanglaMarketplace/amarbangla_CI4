...
<div class="content-wrapper overflow-hidden">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Ledger Bank</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('shop_admin/dashboard') ?>">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Ledger Bank</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Ledger Bank List</h3>
            </div>
            <div class="card-body p-3">
                <div class="row mb-3 " >
                    <div class="col-md-3">
                        <label for="int">Bank name</label>
                        <select class="form-control select2 select2-hidden-accessible" onchange="bankLedg(this.value)" id="bankId" style=" width: 100%;" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-md-2" style="padding: 4px;">
                        <button style="margin-top: 28px;" onclick="bankLedSerc()" class="btn btn-primary " type="submit">Filter</button>
                    </div>
...
<script>
    function bankLedg(id){
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('shop_admin/ledger_bank_search') ?>",
            data: {bank_id: id},
    ...
    function bankLedSerc()
    {
        ...
        if (error == 0){
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('shop_admin/ledger_bank_search_date') ?>",
