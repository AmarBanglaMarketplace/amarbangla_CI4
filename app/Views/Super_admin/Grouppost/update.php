            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?php echo base_url('super_admin/group_post_update_action'); ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?php echo site_url('super_admin/group_post') ?>" class="btn btn-danger">Cancel</a>
